    ...
    <div className="relative min-w-40 flex-1">
      ...
      {open && !link && hits.length > 0 && (
        <div className="absolute z-20 mt-1 w-full overflow-hidden rounded-xl border border-border bg-card shadow-xl">
          ...
          {hits.map((h) => (
            // Stacked layout: full move name on its own line (wraps, never truncates — important on
            // phones), action buttons below.
            <div key={h.id} className="border-b border-border/50 px-3 py-2 last:border-b-0 hover:bg-card-hover">
              ...
              <div className="mt-1.5 flex gap-1.5">
                <button
                  ...
                  className="flex-1 whitespace-nowrap rounded-md bg-accent px-2 py-1.5 text-xs font-semibold text-white"
                ...
                <button
                  ...
                  className="flex-1 whitespace-nowrap rounded-md border border-border px-2 py-1.5 text-xs font-medium text-text-dim hover:border-accent hover:text-accent"
